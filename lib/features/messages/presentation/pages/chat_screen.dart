...
//       ref.read(messageViewModelProvider.notifier).initializeChat();
//     });
//   }
...
//             ),
//           ),
//           if (isMe) const SizedBox(width: 48), // Space for avatar alignment
//         ],
//       ),
//     );
//   }
...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  Future<void> _initializeChat() async {
    ...
    // Load messages for this specific organization
  ...
  Widget build(BuildContext context) {
    ...
    // Debug print to see what messages are being shown
    print('📱 Current channel: ${state.currentChannelId}');
    print('📱 Messages count: ${state.messages.length}');
    for (var msg in state.messages) {
      print('  - ${msg.text} (${msg.userId})');
    }
