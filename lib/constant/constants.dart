...
final List<OrganizationModel> serviceCards = [
  ...
  OrganizationModel(
    ...
    time: "8:00 - 16:00",
    description:
        "Top ranked elite medical university with global faculty, highly selective admissions, and known for Nobel-level medical research, advanced surgery programs, and high funding.",
  ),
];
